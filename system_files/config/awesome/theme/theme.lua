...
local default_theme_path                        = gears.filesystem.get_themes_dir() .. "default/"
local theme                                     = {}
...
theme.titlebar_minimize_button_normal           = default_theme_path .. "titlebar/minimize_normal.png"
theme.titlebar_minimize_button_focus            = default_theme_path .. "titlebar/minimize_focus.png"
